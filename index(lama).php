...
<section class="experience-section">
    <h1 class="main-question" style="color: #FFFF66; text-align: center; margin-bottom: 30px; font-size: 32px;">
        <strong>❕ Apakah Anda Merasa Hidup Anda Mulai Terbatas karena penyakit? ❕</strong>
    </h1>
    
    <h2 class="sub-question" style="color: #FFA500  ; text-align: center; margin-bottom: 25px; font-size: 28px;">
...
<section class="alert-section">
    <div class="alert-box">
        <h3 class="alert-text">
            ...
            <span class="alert-main">Diracik dari alam</span>
...
<section class="solution-section">
    ...
    <div class="video-grid">
        ...
        while($testi = $result->fetch_assoc()): 
        ?>
            <div class="video-container">
                ...
                <?php if(!empty($testi['deskripsi'])): ?>
                    <small><?= htmlspecialchars($testi['deskripsi']) ?></small>
                <?php endif; ?>
            </div>
        <?php endwhile; ?>
    </div>
    ...
    <div class="benefits-container">
        ...
        <div class="benefits-list">
            <div class="benefit-item">
                ...
                <p style="color: #f5f5f5;">Mengatasi masalah tulang, sendi dan saraf</p>
            </div>
            <div class="benefit-item">
                <span class="benefit-icon">💪</span>
...
<section class="notification-section">
    <h1><strong>DAPATKAN PRODUK D-GASSVIT YANG ASLI HANYA DISINI</strong></h1>
</section>
